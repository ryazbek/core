...
#Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*Microsoft.Windows.NarratorQuickStart*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*A278AB0D.MarchofEmpires*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*BytedancePte.Ltd.TikTok*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*CAF9E577.Plex*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*Candy*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*Customer*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*Deezer.62021768415AF*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*DellCommandUpdate*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*DellInc.DellHelpSupport*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*DellInc.DellProductRegistration*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*DellInc.DellSupportAssistforPCs*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*Digital*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*DropboxOEM*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*Fitbit.FitbitCoach*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*FreshPaint*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*HEVCVideoExtension*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*Hidden*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*LinkedInforWindows*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*LiveSafe*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*MAGIX.MusicMakerJam*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*MPEG2VideoExtension*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*PowerManager*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*RivetNetworks.SmartByte*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*ROBLOXCORPORATION.ROBLOX*"} | remove-appxprovisionedpackage -online
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*ScreenovateTechnologies.DellMobileConnect*"} | remove-appxprovisionedpackage -online
...
Get-appxprovisionedpackage -online | where-object {$_.packagename -like "*ThumbmunkeysLtd.PhototasticCollage*"} | remove-appxprovisionedpackage -online
...
#Get-AppxPackage -allusers *Windows.NarratorQuickStart* | Remove-AppxPackage
...
Get-AppxPackage -allusers *Customer* | Remove-AppxPackage
Get-AppxPackage -allusers *Deezer.62021768415AF* | Remove-AppxPackage
Get-AppxPackage -allusers *DellCommandUpdate* | Remove-AppxPackage
Get-AppxPackage -allusers *DellInc.DellHelpSupport* | Remove-AppxPackage
Get-AppxPackage -allusers *DellInc.DellProductRegistration* | Remove-AppxPackage
Get-AppxPackage -allusers *DellInc.DellSupportAssistforPCs* | Remove-AppxPackage
Get-AppxPackage -allusers *Digital* | Remove-AppxPackage
...
Get-AppxPackage -allusers *DropboxOEM* | Remove-AppxPackage
...
Get-AppxPackage -allusers *HEVCVideoExtension* | Remove-AppxPackage
Get-AppxPackage -allusers *Hidden* | Remove-AppxPackage
...
Get-AppxPackage -allusers *LiveSafe* | Remove-AppxPackage
Get-AppxPackage -allusers *MAGIX.MusicMakerJam* | Remove-AppxPackage
Get-AppxPackage -allusers *March* | Remove-AppxPackage
Get-AppxPackage -allusers *McAfeeSecurity* | Remove-AppxPackage
...
Get-AppxPackage -allusers *MPEG2VideoExtension* | Remove-AppxPackage
...
Get-AppxPackage -allusers *PowerManager* | Remove-AppxPackage
Get-AppxPackage -allusers *RivetNetworks.SmartByte* | Remove-AppxPackage
Get-AppxPackage -allusers *ROBLOXCORPORATION.ROBLOX* | Remove-AppxPackage
Get-AppxPackage -allusers *ScreenovateTechnologies.DellMobileConnect* | Remove-AppxPackage
...
Get-AppxPackage -allusers *VP9VideoExtensions* | Remove-AppxPackage
Get-AppxPackage -allusers *WebMediaExtensions* | Remove-AppxPackage
...
Get-AppxPackage -allusers *WikimediaFoundation.Wikipdiaportugus* | Remove-AppxPackage
